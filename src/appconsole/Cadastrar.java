...
public class Cadastrar {
	...
	public Cadastrar() {
		...
		motorista1.novaViagem(viagem.getDestino());
		...
		motorista2.novaViagem(viagem.getDestino());
		veiculo.novaViagem(viagem.getDestino());
		...
		motorista3.novaViagem(viagem.getDestino());
		veiculo.novaViagem(viagem.getDestino());
		...
		motorista4.novaViagem(viagem.getDestino());
		veiculo.novaViagem(viagem.getDestino());
		...
		motorista5.novaViagem(viagem.getDestino());
		veiculo.novaViagem(viagem.getDestino());
